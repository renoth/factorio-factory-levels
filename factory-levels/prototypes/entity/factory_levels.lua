...
function factory_levels.get_furnace(base_machine_name)
	...
	if data.raw["furnace"][base_machine_name] then return data.raw["furnace"][base_machine_name] end
	if data.raw["assembling-machine"][base_machine_name] then return data.raw["assembling-machine"][base_machine_name] end
	return nil
end
...
function factory_levels.get_or_create_machine(machine_type, base_machine_name, level)
	...
	if base_machine == nil then return nil end
