...
burner_furnace_levels = {
	...
	quality_multipliers = { 0.002, 0.002 },
...
if mods["space-age"] then
	...
	factory_levels.create_leveled_machines(biochamber_levels)
end
...
if mods["angelspetrochem"] then
	electrolyzer_levels = {
		...
		quality_multipliers = { 0.002, 0.002, 0.002, 0.002 },
